...
namespace AForge.Neuro
{
    ...
    public abstract class Network
    {
        ...
        {
           var jsonTypeInfo=JsonTypeInfo.CreateJsonTypeInfo<Network>(JsonSerializerOptions.Default);
              //IFormatter formatter = new BinaryFormatter( );
              //Network network = (Network) formatter.Deserialize( stream );
              Network network = JsonSerializer.Deserialize<Network>(stream, jsonTypeInfo);
            return network;
        }
    }
}
